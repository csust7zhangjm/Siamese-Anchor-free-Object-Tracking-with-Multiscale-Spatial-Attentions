...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/mnt/data/train_data/vid/crop511'
__C.DATASET.VID.ANNO = '/mnt/data/train_data/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/mnt/data/ytbb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/mnt/data/ytbb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/mnt/data/coco/crop511'
__C.DATASET.COCO.ANNO = '/mnt/data/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/mnt/data/train_data/det/crop511'
__C.DATASET.DET.ANNO = '/mnt/data/train_data/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.GOT10K = CN()
__C.DATASET.GOT10K.ROOT = '/mnt/data/train_data/got10k/crop511'
__C.DATASET.GOT10K.ANNO = '/mnt/data/train_data/got10k/all.json'
__C.DATASET.GOT10K.FRAME_RANGE = 100
__C.DATASET.GOT10K.NUM_USE = 200000

__C.DATASET.LASOT = CN() #yt_vos
__C.DATASET.LASOT.ROOT = '/mnt/data/train_data/yt_vos/crop511'
__C.DATASET.LASOT.ANNO = '/mnt/data/train_data/yt_vos/train.json'
__C.DATASET.LASOT.FRAME_RANGE = 20
